...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#vacantions">Вакансії</a>
            </li>
            <li class="nav-item">
    ...
    <div id="vacantions" class="container">
		...
		<div class="row">
			<div class="col-lg-12 mb-12">
				<div class="card h-100">
					<h4 class="card-header">Пакування свічок, сортування на брак/не брак</h4>
					<div class="card-body">
						<div class="col-lg-12 col-sm-12 portfolio-item">
							<div class="row">
								<div class="col-lg-3">
									<a>
										<img class="card-img-top" src="{{ asset('assets/img/svi4ky.jpg') }}" alt="">
									</a>
								</div>
								<div class="col-lg-9">
									<div class="card-body">
		...
		<div class="row">
			<div class="col-lg-12 mb-12">
				<div class="card h-100">
					<h4 class="card-header">LG ELECTRONIX</h4>
					<div class="card-body">
						<div class="col-lg-12 col-sm-12 portfolio-item">
							<div class="row">
								<div class="col-lg-3">
									<a>
										<img class="card-img-top" src="{{ asset('assets/img/lg.jpg') }}" alt="">
									</a>
								</div>
								<div class="col-lg-9">
									<div class="card-body">
		...
		<div class="row">
			<div class="col-lg-12 mb-12">
				<div class="card h-100">
					<h4 class="card-header">Автомобільний завод CENTRUM-BMW</h4>
					<div class="card-body">
						<div class="col-lg-12 col-sm-12 portfolio-item">
							<div class="row">
								<div class="col-lg-3">
									<a>
										<img class="card-img-top" src="{{ asset('assets/img/bmw.jpg') }}" alt="">
									</a>
								</div>
								<div class="col-lg-9">
									<div class="card-body">
	...
	<div id="documents" class="row">
		<div class="col-lg-6">
			...
			<p>Які необхідні для оформлення:</p>
			<ul>
				<li>
			...
			<p>В окремих випадках інші документи.</p>
		</div>
		<div class="col-lg-6">
